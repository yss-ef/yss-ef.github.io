...
document.querySelectorAll('a,button,.skill-cat,.project-row,.cert-row,.gh-repo-card').forEach(el=>{
  el.addEventListener('mouseenter',()=>{cur.style.transform='scale(1.6)';ring.style.width=ring.style.height='46px';ring.style.borderColor='rgba(240,192,216,.5)';});
  el.addEventListener('mouseleave',()=>{cur.style.transform='scale(1)';ring.style.width=ring.style.height='32px';ring.style.borderColor='rgba(126,184,247,.4)';});
});
